...
The JSON schema is archive agnostic. It works with [sivtr](https://github.com/Ariestar/sivtr), a different memory index, or an application that exports sessions. No secret is logged, and Jev errors fall back to local ranking with a warning type. For repeated research, avoid re-sending unchanged private excerpts unless needed.
